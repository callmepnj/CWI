...
export const defaultBigBrainRules: BigBrainRule[] = [
  ...
  rule("seo.keywords", "SEO Keywords", "Primary Keywords", "Cockroach Watch India, CWI, CWI Live Newsroom, CWI Watch Desk, CWI articles, CWI India Unanswered Files, India Unanswered Files, CWI public issues, CWI youth voice, CWI civic watch, Document Verify Amplify."),
  ...
  rule("vertical.live_newsroom", "Live Newsroom Rules", "CWI Live Newsroom", "Live Newsroom is the default CWI OS destination. Existing agents must prepare source-backed updates for /live-newsroom unless the admin selects Watch Desk, India Unanswered Files, Public Advisory, or Social Only."),
