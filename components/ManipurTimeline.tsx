          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center gap-2 rounded-full bg-urgent/10 px-3 py-1 font-mono text-[0.68rem] font-black uppercase tracking-[0.16em] text-urgent ring-1 ring-urgent/20">
              ...
              <p className="mt-3 text-base leading-7 text-ink/72">{item.summary}</p>
              <div className="mt-4 flex flex-wrap gap-2">
                {sources.map((source) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-full border border-line bg-paper px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.12em] text-ink/58 transition hover:border-royal/35 hover:bg-skywash hover:text-royal"
                  >
                    {source.publisher}
                  </a>
                ))}
