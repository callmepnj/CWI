    ...
    >
      <Card>
        ...
        <p className="text-lg leading-8 text-ink/72">
          CWI is a civic watch, satire, commentary, and public archive platform. This policy explains how submitted information may be used when readers interact with the CWI Live Newsroom, CWI Archive, CWI India Unanswered Files, report forms, and comment sections.
        </p>
      </Card>
